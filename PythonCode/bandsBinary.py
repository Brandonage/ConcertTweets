...
for n, f in neighboursAndFactors:
    ...
    totaluserRMSE.append(userRMSE)
    totaluserPrec.append(userPrec)
    totaluserRecall.append(userRecall)
    totalitemRMSE.append(itemRMSE)
    totalitemPrec.append(itemPrec)
    totalitemRecall.append(itemRecall)
    totalfactorsRMSE.append(factorsRMSE)
    totalfactorsPrec.append(factorsPrec)
    totalfactorsRecall.append(factorsRecall)

results = []
for i in xrange(len(neighboursAndFactors)):
    results.append(round(np.mean(totalfactorsRecall[i]),4))
